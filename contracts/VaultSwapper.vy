...
minters: public(HashMap[address, address])
management: public(address)

@external
def __init__():
    self.management = msg.sender
    self.minters[0x7Eb40E450b9655f4B3cC4259BCC731c63ff55ae6] = 0x42d7025938bEc20B69cBae5A77421082407f053A
    self.minters[0x64eda51d3Ad40D56b9dFc5554E06F94e1Dd786Fd] = 0xC25099792E9349C7DD09759744ea681C7de2cb66
    self.minters[0x1AEf73d49Dedc4b1778d0706583995958Dc862e6] = 0x8474DdbE98F5aA3179B3B3F5942D724aFcdec9f6
    self.minters[0x97E2768e8E73511cA874545DC5Ff8067eB19B787] = 0x3E01dD8a5E1fb3481F0F589056b428Fc308AF0Fb
    self.minters[0x3E01dD8a5E1fb3481F0F589056b428Fc308AF0Fb] = 0x3E01dD8a5E1fb3481F0F589056b428Fc308AF0Fb
    self.minters[0xEd279fDD11cA84bEef15AF5D39BB4d4bEE23F0cA] = 0xEd279fDD11cA84bEef15AF5D39BB4d4bEE23F0cA
    self.minters[0xEcd5e75AFb02eFa118AF914515D6521aaBd189F1] = 0xEcd5e75AFb02eFa118AF914515D6521aaBd189F1
    self.minters[0x5B5CFE992AdAC0C9D48E05854B2d91C73a003858] = 0x3eF6A01A0f81D6046290f3e2A8c5b843e738E604
    self.minters[0x4f3E8F405CF5aFC05D68142F3783bDfE13811522] = 0x0f9cb53Ebe405d49A0bbdBD291A65Ff571bC83e1
    self.minters[0x4807862AA8b2bF68830e4C8dc86D0e9A998e085a] = 0x4807862AA8b2bF68830e4C8dc86D0e9A998e085a
...
def swap(from_vault: address, to_vault: address, amount: uint256, min_amount_out: uint256):
    ...
    underlying_pool: address = self.minters[underlying]
    if underlying_pool == ZERO_ADDRESS:
        underlying_pool= Token(underlying).minter()

    target_pool: address = self.minters[target]
...
@external
def setMinter(token: address, minter: address):
    assert(msg.sender == self.management)
    self.minters[token] = minter
